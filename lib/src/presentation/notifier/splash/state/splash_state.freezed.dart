...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ScreenState? screenState, String path});
}
...
class _$SplashStateCopyWithImpl<$Res, $Val extends SplashState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      screenState: freezed == screenState
          ? _value.screenState
...
class _$SplashStateImpl implements _SplashState {
  _$SplashStateImpl({this.screenState = ScreenState.initial, this.path = ""});
  ...
  @override
  String toString() {
    return 'SplashState(screenState: $screenState, path: $path)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, screenState, path);
...
abstract class _SplashState implements SplashState {
  factory _SplashState({final ScreenState? screenState, final String path}) =
      _$SplashStateImpl;
