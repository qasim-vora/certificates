...
class _$BottomNavStateImpl implements _BottomNavState {
  _$BottomNavStateImpl({this.index = 0, this.screen = const HomeScreen()});
  ...
  @override
  String toString() {
    return 'BottomNavState(index: $index, screen: $screen)';
  }
...
abstract class _BottomNavState implements BottomNavState {
  factory _BottomNavState({final int index, final Widget screen}) =
